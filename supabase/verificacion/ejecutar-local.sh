...
for f in 01-inspeccionar-esquema 05-circuito-de-venta 06-ataques 07-administrador 08-estructura-fiscal 09-manual-operativo 10-especificacion-tecnica 11-circuito-de-venta 12-quien-mueve-el-pedido 13-los-otros-cuatro-huecos 16-las-fotos-del-catalogo; do
  echo; echo "################ $f ################"
  ejecutar "$AQUI/$f.sql"
done
